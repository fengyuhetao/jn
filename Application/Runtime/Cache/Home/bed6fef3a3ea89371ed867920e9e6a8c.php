...
<!-- 页面头部 start -->
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="index.html"><img src="/jn/Public/Home/images/logo.png" alt="京西商城"></a></h2>
		</div>
	</div>
	<!-- 页面头部 end -->
	...
	<div class="login w990 bc mt10 regist">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="/jn/index.php/Home/Member/regist.html" method="post">
					<ul>
						<li>
							<label for="">用户名：</label>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="checkbox" class="chb" checked="checked" name="mustClick" /> 我已阅读并同意《用户注册协议》
						</li>
						<li>
							<label for="">&nbsp;</label>
