	...
	<table cellpadding="3" cellspacing="1">
		...
		<?php foreach ($data as $k => $v): ?>            
			<tr class="tron">
				...
				<td><?php echo $v['gn']; ?></td>
		        <td align="center">
		        	<a href="<?php echo U('goodsNumber?id='.$v['id'].'&p='.I('get.p'));?>" title="库存量">库存量</a> |
		        	<a href="<?php echo U('edit?id='.$v['id'].'&p='.I('get.p')); ?>" title="编辑">编辑</a> |
	                <a href="<?php echo U('recycle?id='.$v['id'].'&p='.I('get.p')); ?>" onclick="return confirm('确定要放入回收站？');" title="移除">放入回收站</a> 
		        </td>
	        </tr>
        <?php endforeach; ?> 
