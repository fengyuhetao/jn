...
<div class="main-div">
    <form name="main_form" method="POST" action="/jn/index.php/Admin/Admin/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">所在角色:</td>
                <td>
                    <?php foreach ($rData as $k => $v): ?>
                        <input type="checkbox" value="<?php echo ($v["id"]); ?>" name="role_id[]"><?php echo ($v["role_name"]); ?><br/>
                    <?php endforeach ?>
                </td>
            </tr>
            <tr>
