...
<body>
<form method="POST" action="/jn/index.php/Admin/Goods/edit/id/18/p/1.html" enctype="multipart/form-data">
	...
	<img src="/jn/Public/Uploads/<?php echo $info['sm_logo'];?>" alt="无图片"/>
	商品logo:<input type="file" name="logo" /><br />
	商品描述:<textarea name="goods_desc" id="goods_desc" value="<?php echo $info['goods_desc'];?>"></textarea><br />
	是否上架:
