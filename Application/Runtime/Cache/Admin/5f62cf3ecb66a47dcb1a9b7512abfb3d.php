...
.explode {
  background:url(/jn/Public/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/jn/Public/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/jn/Public/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/jn/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U(MODULE_NAME.'/Goods/lst');?>" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="<?php echo U(MODULE_NAME.'/Goods/add');?>" target="main-frame">添加新商品</a></li>
...
<script type="text/javascript" src="/jn/Public/Admin/Js/global.js"></script>
<script type="text/javascript" src="/jn/Public/Admin/Js/utils.js"></script>
<script type="text/javascript" src="/jn/Public/Admin/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/jn/Public/Admin/Images/menu_minus.gif' : '/jn/Public/Admin/Images/menu_plus.gif';
