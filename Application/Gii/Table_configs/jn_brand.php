<?php
return array(
	'tableName' => 'jn_brand',    // 表名
	'tableCnName' => '品牌表',  // 表的中文名
	'moduleName' => 'Admin',  // 代码生成到的模块
	'digui' => 0,             // 是否无限级（递归）
	'diguiName' => '',        // 递归时用来显示的字段的名字，如cat_name（分类名称）
	'pk' => 'id',    // 表中主键字段名称
	'topPriName' => '商品管理',//把品牌的权限放到商品管理的子权限
	/********************* 要生成的模型文件中的代码 ******************************/
	...
	'validate' => "
		...
		array('site_url', 'require', '品牌网站网址不能为空！', 1, 'regex', 3),
		array('site_url', '1,150', '品牌网站网址的值最长不能超过 150 个字符！', 1, 'length', 3),
	",
	/********************** 表中每个字段信息的配置 ****************************/
	'fields' => array(
		'brand_name' => array(
		...
		'logo' => array(
			'text' => '品牌logo',
			'type' => 'file',
			'save_fields' => array('logo'), //图片存到那个字段
			'default' => '',
		),
	),
	/**************** 搜索字段的配置 **********************/
